...
echo $(( num1 % num2 ))
#
#Example-6: Square root of two numbers
#!/bin/bash
echo
...
echo "sqrt( $num1 )" | bc -l
#
#Example-7: Cube root of two numbers
#!/bin/bash
echo
...
echo "( $num1^3 )" | bc -l
#
#Example-8: Num1 to the power Num2
#!/bin/bash
echo
echo "Enther a two numbers to perfotm num1 to the power num2:"
read num1 num2
echo "( $num1^$num2 )" | bc -l
#Example-9: Arithmetic operations of two floating numbers
#!/bin/bash
echo
